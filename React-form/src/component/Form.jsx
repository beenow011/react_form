...
const Form = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      <div className="bg-formImg bg-cover bg-center h-2/3 md:h-auto m-6 md:w-[50vw] ml-6 md:ml-40 p-6 mt-11 rounded-xl shadow-xl shadow-purple-950 hover:shadow-orange-300 ">
